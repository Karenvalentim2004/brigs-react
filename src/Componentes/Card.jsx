    ...
    return (
        <section className="container my-4 py-4">
            <div className="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                ...
                <div className="col">
                    <div className="card h-100">
                        <img src="Imagens/craquelado.jpg" className="card-img-top" alt="Ovos de Páscoa" />
                        <div className="card-body text-center">
                ...
                <div className="col">
                    <div className="card h-100">
                        <img src="Imagens/bolo brig.jpg" className="card-img-top" alt="Bolos" />
                        <div className="card-body text-center">
                ...
                <div className="col">
                    <div className="card h-100">
                        <img src="Imagens/te amo.jpg" className="card-img-top" alt="Presentes" />
                        <div className="card-body text-center">
